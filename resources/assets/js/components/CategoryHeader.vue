	            ...
	            <div class="category-header-middle">
                    <h1 v-if="$route.name == 'category'">
        				<router-link :to="'/c/' + Store.category.name" class="flex-center-inline">
	                        <img src="https://cdn.jsdelivr.net/npm/twemoji@2.5.0/2/svg/23-20e3.svg" style="width:23px;margin-right:8px">{{ Store.category.name }}
	                	</router-link>
                    </h1>
	...
	<nav class="nav has-shadow user-select">
	    <div class="container">
	        ...
	        <div class="channel-admin-btn">
            	...
            	<router-link :to="{ path: '/c/' + $route.params.name + '/mod' }" class="v-button v-button--blue"
				v-if="isModerator">
					Moderation
				</router-link>
