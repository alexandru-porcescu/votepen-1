    ...
    <div class="emojiPicker-wrapper">
        ...
        <div class="emoji-list">
            <div class="align-left" v-if="filteredHistory.length">
                ...
                :src="'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.2.7/assets/svg/' + e.unicode + '.svg'">
            </div>
            ...
            :src="'https://cdnjs.cloudflare.com/ajax/libs/emojione/2.2.7/assets/svg/' + emoji.unicode + '.svg'">
        </div>
    </div>
</template>
