        ...
        <div class="v-modal-small-box v-modal-small-box--light" v-on-clickaway="close">
            <div class="flex1">
				...
				<div class="form-login" v-show="type == 'login'"  @keyup.enter="login">
					<a href="/login/google" class="v-button v-button--social-login v-button--google v-button--block">
						<i class="v-icon v-google"></i>
						Google
					</a>
					<a href="/login/facebook" class="v-button v-button--social-login v-button--facebook v-button--block">
