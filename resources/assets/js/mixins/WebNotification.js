export default {
    methods: {
         ...
         */
        webNotification: function (title, body, url, icon = 'https://cdn.jsdelivr.net/npm/votepen@12.0.0/imgs/v-logo.png') {
            let self = this
                    ...
                    // Hasn't asked user web notifications permission
                        ...
                        Notification.requestPermission(function (permission) {
                            if (permission === "granted") {
                                var notification = new Notification(title, {
                                    body: body,
                                    icon: 'https://cdn.jsdelivr.net/npm/votepen@12.0.0/imgs/v-logo.png'
                                })
                                notification.onclick = function() {
                                    if (url == 'new-message') {
                                        Store.contentRouter = 'messages'
